...
def main():
    ...
    if args.apply:
        ...
        print(json.dumps({"dry_run": False, "output": str(out), "files": sorted(graphs)}, ensure_ascii=False, indent=2))
    else:
        print(json.dumps({"dry_run": True, "output": str(out), "files": sorted(graphs)}, ensure_ascii=False, indent=2))
